...
// adaptado do código baixado de https://tips4java.wordpress.com/2008/11/27/bean-table-model/ no dia 18/5/2021
...
//
	...
	{
		if (modelData.isEmpty()) return null;
		else return modelData.get( row );
	}
